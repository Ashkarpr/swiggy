...
const biriyani = ({navigation}) =>
{
      ...
      <View style={{backgroundColor:"#f7f2f2",}}>
        ...
        <View >
         ...
         <TouchableOpacity style={{top:"57%"}} onPress ={()=> setfirstbiriyanimodal (false)}>
          ...
          <Image  style={{borderRadius:10,marginTop:"3%",height:"60%",width:"90%", alignSelf:"center"}}source={require('../assets/vegb1.jpg')}></Image>
           ...
           <Text style={{fontWeight:"bold",left:"8%",top:"-5%"}}>Veg Biriyani</Text>
        ...
        <View >
         ...
         <TouchableOpacity style={{top:"57%"}} onPress ={()=> setsecondbiriyanimodal (false)}>
          <View style={{backgroundColor: 'white'}} >
          <Image  style={{borderRadius:10,marginTop:"3%",height:"60%",width:"90%", alignSelf:"center"}}source={require('../assets/vegb2.jpg')}></Image>
           <Image style={{height:20,width:20,top:"4%",left:"8%"}} source={require('../assets/veg1.png')}></Image>
           <Text style={{left:"17%",fontSize:14,color:"darkorange",top:"-1.4%"}} > BEST SELLER</Text>
           <Entypo name="star" size={20} color="darkorange" style={{top:"-7%",left:"13%"}}></Entypo>
           <Text style={{fontWeight:"bold",left:"8%",top:"-5%"}}>Veg Biriyani</Text>
        ...
        <View >
         ...
         <TouchableOpacity style={{top:"57%"}} onPress ={()=> setthirdbiriyanimodal (false)}>
          <View style={{backgroundColor: 'white'}} >
          <Image  style={{borderRadius:10,marginTop:"3%",height:"60%",width:"90%", alignSelf:"center"}}source={require('../assets/vegb3.jpg')}></Image>
           <Image style={{height:20,width:20,top:"4%",left:"8%"}} source={require('../assets/veg1.png')}></Image>
           <Text style={{left:"17%",fontSize:14,color:"darkorange",top:"-1.4%"}} > BEST SELLER</Text>
           <Entypo name="star" size={20} color="darkorange" style={{top:"-7%",left:"13%"}}></Entypo>
           <Text style={{fontWeight:"bold",left:"8%",top:"-5%"}}>Veg Biriyani</Text>
         ...
         <TouchableOpacity style={{top:"57%"}} onPress ={()=> setfourthbiriyanimodal (false)}>
          <View style={{backgroundColor: 'white'}} >
          <Image  style={{borderRadius:10,marginTop:"3%",height:"60%",width:"90%", alignSelf:"center"}}source={require('../assets/vegb4.jpg')}></Image>
           <Image style={{height:20,width:20,top:"4%",left:"8%"}} source={require('../assets/veg1.png')}></Image>
           <Text style={{left:"17%",fontSize:14,color:"darkorange",top:"-1.4%"}} > BEST SELLER</Text>
           <Entypo name="star" size={20} color="darkorange" style={{top:"-7%",left:"13%"}}></Entypo>
           <Text style={{fontWeight:"bold",left:"8%",top:"-5%"}}>Veg Biriyani</Text>
         ...
         <TouchableOpacity style={{top:"57%"}} onPress ={()=> setfifthbiriyanimodal (false)}>
          <View style={{backgroundColor: 'white'}} >
          <Image  style={{borderRadius:10,marginTop:"3%",height:"60%",width:"90%", alignSelf:"center"}}source={require('../assets/vegb5.jpg')}></Image>
           <Image style={{height:20,width:20,top:"4%",left:"8%"}} source={require('../assets/veg1.png')}></Image>
           <Text style={{left:"17%",fontSize:14,color:"darkorange",top:"-1.4%"}} > BEST SELLER</Text>
           <Entypo name="star" size={20} color="darkorange" style={{top:"-7%",left:"13%"}}></Entypo>
           <Text style={{fontWeight:"bold",left:"8%",top:"-5%"}}>Veg Biriyani</Text>
    ...
    {/* taping names like veg, nin-veg etc................. */}
      ...
      <View style={{backgroundColor:"white", marginTop:11}}>
          <Image style={{height:20,width:20,top:"36%",left:16}} source={require('../assets/veg1.png')}></Image>
       ...
       <View style={{flexDirection:"row",}}>
          ...
          <Image style={{borderRadius:20,height:135,width:150, marginTop:10,marginBottom:20, marginLeft:110}}source={require('../assets/vegb1.jpg')}></Image>
          </TouchableOpacity>
...
<View style={{marginTop:"-24%"}}>
          <Image style={{height:20,width:20,top:"34%",left:16}} source={require('../assets/veg1.png')}></Image>
       ...
       <View style={{flexDirection:"row",}}>
          ...
          <Image style={{borderRadius:20,height:135,width:150, marginTop:10,marginBottom:20, marginLeft:110}}source={require('../assets/vegb2.jpg')}></Image>
          </TouchableOpacity>
          <View style={{marginLeft:"-31%",marginTop:"32%",width:"25%"}}>
            <TouchableOpacity >
              <Text style={{backgroundColor:"white",fontWeight:"bold",color:"green",borderColor:"gray",
...
<Image style={{height:20,width:20,top:"34%",left:16}} source={require('../assets/veg1.png')}></Image>
       ...
       <View style={{flexDirection:"row",}}>
          ...
          <Image style={{borderRadius:20,height:135,width:150, marginTop:10,marginBottom:20, marginLeft:110}}source={require('../assets/vegb3.jpg')}></Image>
          </TouchableOpacity>
          <View style={{marginLeft:"-31%",marginTop:"32%",width:"25%"}}>
            <TouchableOpacity >
              <Text style={{backgroundColor:"white",fontWeight:"bold",color:"green",borderColor:"gray",
...
<Image style={{height:20,width:20,top:"34%",left:16}} source={require('../assets/veg1.png')}></Image>
       ...
       <View style={{flexDirection:"row",}}>
          ...
          <Image style={{borderRadius:20,height:135,width:150, marginTop:10,marginBottom:20, marginLeft:110}}source={require('../assets/vegb4.jpg')}></Image>
          </TouchableOpacity>
          <View style={{marginLeft:"-31%",marginTop:"32%",width:"25%"}}>
            <TouchableOpacity >
              <Text style={{backgroundColor:"white",fontWeight:"bold",color:"green",borderColor:"gray",
...
<Image style={{height:20,width:20,top:"34%",left:16}} source={require('../assets/veg1.png')}></Image>
       ...
       <View style={{flexDirection:"row",}}>
          ...
          <Image style={{borderRadius:20,height:135,width:150, marginTop:10,marginBottom:20, marginLeft:110}}source={require('../assets/vegb5.jpg')}></Image>
          </TouchableOpacity>
          <View style={{marginLeft:"-31%",marginTop:"32%",width:"25%"}}>
            <TouchableOpacity >
              <Text style={{backgroundColor:"white",fontWeight:"bold",color:"green",borderColor:"gray",
